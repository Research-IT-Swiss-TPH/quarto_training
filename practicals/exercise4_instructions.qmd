...
-   [ ] Link the bibliography file by adding it to the YAML header of your Quarto notebook;
-   [ ] Add a reference for [10.1016/S0140-6736(24)02669-2](https://doi.org/10.1016/S0140-6736(24)02669-2) in the `.bib` file;
...
-   [ ] Insert the following sentence into the `Background` section, and replace the placeholder text in bold with the correct citation key from your `.bib` file.
...
- If you are not proficient with the source editor, Quarto’s visual mode provides user-friendly tools for managing citations.
...
-   [ ] To go further you can try creating your own template and applying it to your MS Word rendered report.
