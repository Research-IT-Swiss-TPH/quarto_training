...
- If you are not familiar with BibTeX files or the source editor, Quarto’s visual mode offers user-friendly tools for managing citations, allowing you to handle most of these steps automatically.
...
-   [ ] To go further, try creating your own custom Word template and apply it to your report to explore how styles can be personalized.
