...
subtitle: 📙 Exercise 3 - step-by-step correction
author:
  - name:
      given: Hélène
      family: Langet
...
-   [X] Update the title of the Quarto document ;
...
-   [X] Put your name as author of the Quarto document ;
...
-   [X] Add the date `2023-12-31` to the Quarto document ;
...
-   [X] Change the output format to generate a MS Word document ;
...
-   [X] Configure the Quarto document to hide code in the rendered MS Word document ;
...
-   [X] Configure the Quarto document to hide warnings in the rendered MS Word document.
...
Your YAML header should now look as follows:
