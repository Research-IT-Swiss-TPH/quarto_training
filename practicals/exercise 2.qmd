...
A Quarto document is organized into the following components:

-   **YAML header**: document parameters
-   **text**: lightweight markup language
-   **code**: embedded executable code
...
To run the code in *notebook* mode, click the green arrow on the right.
