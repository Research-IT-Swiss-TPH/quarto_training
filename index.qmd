...
We value your input! Use Hypothesis to share your feedback and help us improve this training.

- Activate *Hypothesis* and log in
- Activate *Hypothesis*: Click on the Hypothesis icon in your browser’s toolbar or press `a` or `h`  on your keyboard to open the Hypothesis sidebar.

When providing feedback, aim to be constructive and specific. 
