...
::: {.column width="30%"}
![](images/Untitled.jpg){fig-align="center"}
:::
:::::
...
If you encounter issues setting up your Python environment, please let us know.
...
-   Ensure that data structures are compatible. For example, R data frames are automatically converted to [https://pandas.pydata.org/](Pandas) data frames in Python, but other complex R objects may not be directly accessible in Python.
